...
public class GraphFeatureRepositoryTest {
    ...
    public void getFeaturesByInteractionAc(){
        ...
        Assert.assertNotNull("Interactor preferredIdentifier xref not present",graphFeatureEvidence.getParticipantEvidence().getInteractor().getPreferredIdentifier());
        Assert.assertEquals("Interactor preferredIdentifier xref is not correct","EBI-9998887",graphFeatureEvidence.getParticipantEvidence().getInteractor().getPreferredIdentifier().getId());
