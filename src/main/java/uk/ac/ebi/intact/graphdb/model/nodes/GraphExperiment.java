...
*/
    ...
    public int hashCode() {
        ...
        try {
            ...
            hashcode = 31 * hashcode + HashCode.interactionEvidencesHashCode(this.getInteractionEvidences());
        } catch (Exception e) {
    ...
    public String createUniqueKey(Experiment experiment) {
        int hashcode = 0;
        if (experiment != null) {
            hashcode = UnambiguousExperimentComparator.hashCode(experiment);
            hashcode = 31 * hashcode + HashCode.interactionEvidencesHashCode(experiment.getInteractionEvidences());
        }
